...
export default function RequestApproval() {
  ...
  const fetchRequests = async () => {
    try {
      ...
      const response = await fetch("https://circulation-system-server.onrender.com/api/requests");
  ...
  const handleApprove = async (requestId) => {
    try {
      ...
      const response = await fetch(
        `https://circulation-system-server.onrender.com/api/requests/${requestId}/approve`,
        { method: "PUT" }
      );
  ...
  const handleReject = async (requestId) => {
    try {
      ...
      const response = await fetch(
        `https://circulation-system-server.onrender.com/api/requests/${requestId}/reject`,
        { method: "PUT" }
      );
