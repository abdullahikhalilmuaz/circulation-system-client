...
export default function Notification() {
  ...
  const fetchAllNotifications = async () => {
    try {
      setLoading(true);
      const response = await fetch("https://circulation-system-server.onrender.com/api/notifications");
  ...
  const markAsRead = async (notificationId) => {
    try {
      const response = await fetch(
        `https://circulation-system-server.onrender.com/api/notifications/${notificationId}/read`,
        { method: "PUT" }
      );
